...
export const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Invoices', href: '/sales/invoices', icon: ReceiptIcon, permission: 'invoice:read', phase: 4 },
      { label: 'Estimates', href: '/sales/estimates', icon: FileTextIcon, permission: 'invoice:read', phase: 4 },
      { label: 'Sales receipts', href: '/sales/sales-receipts', icon: ReceiptIcon, permission: 'invoice:read', phase: 4 },
      { label: 'Credit memos', href: '/sales/credit-memos', icon: FileTextIcon, permission: 'invoice:read', phase: 4 },
      { label: 'Payments', href: '/payments', icon: BanknoteIcon, permission: 'payment:read', phase: 4 },
    ],
  },
  {
    label: 'Purchases',
    items: [
      ...
      { label: 'Bills', href: '/purchases/bills', icon: ReceiptIcon, permission: 'bill:read', phase: 5 },
      { label: 'Expenses', href: '/purchases/expenses', icon: ReceiptIcon, permission: 'expense:read', phase: 5 },
      { label: 'Vendor credits', href: '/purchases/vendor-credits', icon: FileTextIcon, permission: 'bill:read', phase: 5 },
      { label: 'Purchase orders', href: '/purchases/purchase-orders', icon: FileTextIcon, permission: 'bill:read', phase: 5 },
      { label: 'Bill payments', href: '/bill-payments', icon: BanknoteIcon, permission: 'expense:read', phase: 5 },
    ],
  },
  {
    label: 'Operations',
...
export const DELIVERED_PHASE = 6

-- AlterEnum
ALTER TYPE "JournalStatus" ADD VALUE 'DELETED';

-- AlterTable
ALTER TABLE "bank_transfers" ADD COLUMN     "deleteReason" TEXT,
ADD COLUMN     "deletedAt" TIMESTAMPTZ(6),
ADD COLUMN     "deletedById" TEXT;

-- AlterTable
ALTER TABLE "bill_payments" ADD COLUMN     "deleteReason" TEXT,
ADD COLUMN     "deletedAt" TIMESTAMPTZ(6),
ADD COLUMN     "deletedById" TEXT;

-- AlterTable
ALTER TABLE "customer_payments" ADD COLUMN     "deleteReason" TEXT,
ADD COLUMN     "deletedAt" TIMESTAMPTZ(6),
ADD COLUMN     "deletedById" TEXT;

-- AlterTable
ALTER TABLE "deposits" ADD COLUMN     "deleteReason" TEXT,
ADD COLUMN     "deletedAt" TIMESTAMPTZ(6),
ADD COLUMN     "deletedById" TEXT;

-- AlterTable
ALTER TABLE "inventory_adjustments" ADD COLUMN     "deleteReason" TEXT,
ADD COLUMN     "deletedAt" TIMESTAMPTZ(6),
ADD COLUMN     "deletedById" TEXT;

-- AlterTable
ALTER TABLE "items" ADD COLUMN     "deleteReason" TEXT,
ADD COLUMN     "deletedAt" TIMESTAMPTZ(6),
ADD COLUMN     "deletedById" TEXT;

-- AlterTable
ALTER TABLE "journals" ADD COLUMN     "deleteReason" TEXT,
ADD COLUMN     "deletedAt" TIMESTAMPTZ(6),
ADD COLUMN     "deletedById" TEXT;

-- AlterTable
ALTER TABLE "purchase_documents" ADD COLUMN     "deleteReason" TEXT,
ADD COLUMN     "deletedAt" TIMESTAMPTZ(6),
ADD COLUMN     "deletedById" TEXT;

-- AlterTable
ALTER TABLE "sales_documents" ADD COLUMN     "deleteReason" TEXT,
ADD COLUMN     "deletedAt" TIMESTAMPTZ(6),
ADD COLUMN     "deletedById" TEXT;

-- CreateIndex
CREATE INDEX "bank_transfers_orgId_deletedAt_idx" ON "bank_transfers"("orgId", "deletedAt");

-- CreateIndex
CREATE INDEX "bill_payments_orgId_deletedAt_idx" ON "bill_payments"("orgId", "deletedAt");

-- CreateIndex
CREATE INDEX "customer_payments_orgId_deletedAt_idx" ON "customer_payments"("orgId", "deletedAt");

-- CreateIndex
CREATE INDEX "deposits_orgId_deletedAt_idx" ON "deposits"("orgId", "deletedAt");

-- CreateIndex
CREATE INDEX "inventory_adjustments_orgId_deletedAt_idx" ON "inventory_adjustments"("orgId", "deletedAt");

-- CreateIndex
CREATE INDEX "items_orgId_deletedAt_idx" ON "items"("orgId", "deletedAt");

-- CreateIndex
CREATE INDEX "journals_orgId_deletedAt_idx" ON "journals"("orgId", "deletedAt");

-- CreateIndex
CREATE INDEX "purchase_documents_orgId_deletedAt_idx" ON "purchase_documents"("orgId", "deletedAt");

-- CreateIndex
CREATE INDEX "sales_documents_orgId_deletedAt_idx" ON "sales_documents"("orgId", "deletedAt");

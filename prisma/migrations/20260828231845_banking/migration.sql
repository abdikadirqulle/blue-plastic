-- CreateEnum
CREATE TYPE "BankDocumentStatus" AS ENUM ('POSTED', 'VOID');

-- CreateEnum
CREATE TYPE "ImportedTransactionStatus" AS ENUM ('PENDING', 'MATCHED', 'EXCLUDED');
...
CONSTRAINT "deposit_lines_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "reconciliation_entries" (
    ...
    "clearedAt" TIMESTAMPTZ(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,

CONSTRAINT "reconciliation_entries_pkey" PRIMARY KEY ("id")
);

-- CreateIndex
CREATE INDEX "bank_transfers_orgId_date_idx" ON "bank_transfers"("orgId", "date" DESC);

-- CreateIndex
CREATE UNIQUE INDEX "bank_transfers_orgId_number_key" ON "bank_transfers"("orgId", "number");

-- CreateIndex
CREATE INDEX "deposits_orgId_date_idx" ON "deposits"("orgId", "date" DESC);

-- CreateIndex
CREATE UNIQUE INDEX "deposits_orgId_number_key" ON "deposits"("orgId", "number");

-- CreateIndex
CREATE UNIQUE INDEX "deposits_id_orgId_key" ON "deposits"("id", "orgId");

-- CreateIndex
CREATE INDEX "deposit_lines_orgId_depositId_idx" ON "deposit_lines"("orgId", "depositId");

-- CreateIndex
CREATE UNIQUE INDEX "deposit_lines_depositId_lineNumber_key" ON "deposit_lines"("depositId", "lineNumber");

-- CreateIndex
CREATE UNIQUE INDEX "deposit_lines_customerPaymentId_key" ON "deposit_lines"("customerPaymentId");

-- CreateIndex
CREATE INDEX "imported_transactions_orgId_accountId_status_date_idx" ON "imported_transactions"("orgId", "accountId", "status", "date");

-- CreateIndex
CREATE UNIQUE INDEX "imported_transactions_orgId_accountId_externalId_key" ON "imported_transactions"("orgId", "accountId", "externalId");

-- CreateIndex
CREATE INDEX "bank_reconciliations_orgId_accountId_statementDate_idx" ON "bank_reconciliations"("orgId", "accountId", "statementDate" DESC);

-- CreateIndex
CREATE INDEX "reconciliation_entries_orgId_reconciliationId_idx" ON "reconciliation_entries"("orgId", "reconciliationId");

-- CreateIndex
CREATE UNIQUE INDEX "reconciliation_entries_journalLineId_key" ON "reconciliation_entries"("journalLineId");

-- AddForeignKey
ALTER TABLE "bank_transfers" ADD CONSTRAINT "bank_transfers_orgId_fkey" FOREIGN KEY ("orgId") REFERENCES "organizations"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "bank_transfers" ADD CONSTRAINT "bank_transfers_fromAccountId_fkey" FOREIGN KEY ("fromAccountId") REFERENCES "ledger_accounts"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "bank_transfers" ADD CONSTRAINT "bank_transfers_toAccountId_fkey" FOREIGN KEY ("toAccountId") REFERENCES "ledger_accounts"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "bank_transfers" ADD CONSTRAINT "bank_transfers_journalId_fkey" FOREIGN KEY ("journalId") REFERENCES "journals"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "deposits" ADD CONSTRAINT "deposits_orgId_fkey" FOREIGN KEY ("orgId") REFERENCES "organizations"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "deposits" ADD CONSTRAINT "deposits_bankAccountId_fkey" FOREIGN KEY ("bankAccountId") REFERENCES "ledger_accounts"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "deposits" ADD CONSTRAINT "deposits_journalId_fkey" FOREIGN KEY ("journalId") REFERENCES "journals"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "deposit_lines" ADD CONSTRAINT "deposit_lines_depositId_fkey" FOREIGN KEY ("depositId") REFERENCES "deposits"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "deposit_lines" ADD CONSTRAINT "deposit_lines_customerPaymentId_fkey" FOREIGN KEY ("customerPaymentId") REFERENCES "customer_payments"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "deposit_lines" ADD CONSTRAINT "deposit_lines_accountId_fkey" FOREIGN KEY ("accountId") REFERENCES "ledger_accounts"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "imported_transactions" ADD CONSTRAINT "imported_transactions_orgId_fkey" FOREIGN KEY ("orgId") REFERENCES "organizations"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "imported_transactions" ADD CONSTRAINT "imported_transactions_accountId_fkey" FOREIGN KEY ("accountId") REFERENCES "ledger_accounts"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "imported_transactions" ADD CONSTRAINT "imported_transactions_matchedJournalLineId_fkey" FOREIGN KEY ("matchedJournalLineId") REFERENCES "journal_lines"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "bank_reconciliations" ADD CONSTRAINT "bank_reconciliations_orgId_fkey" FOREIGN KEY ("orgId") REFERENCES "organizations"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "bank_reconciliations" ADD CONSTRAINT "bank_reconciliations_accountId_fkey" FOREIGN KEY ("accountId") REFERENCES "ledger_accounts"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "reconciliation_entries" ADD CONSTRAINT "reconciliation_entries_reconciliationId_fkey" FOREIGN KEY ("reconciliationId") REFERENCES "bank_reconciliations"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "reconciliation_entries" ADD CONSTRAINT "reconciliation_entries_journalLineId_fkey" FOREIGN KEY ("journalLineId") REFERENCES "journal_lines"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- CreateEnum
CREATE TYPE "InventoryMovementType" AS ENUM ('PURCHASE', 'SALE', 'SALE_RETURN', 'PURCHASE_RETURN', 'ADJUSTMENT', 'OPENING');

-- AlterTable
ALTER TABLE "organizations" ADD COLUMN     "allowNegativeStock" BOOLEAN NOT NULL DEFAULT false;
...
CREATE TABLE "inventory_transactions" (
    ...
    "runningQuantity" DECIMAL(19,4) NOT NULL,
...
CREATE TABLE "inventory_adjustment_lines" (
    ...
    "previousQuantity" DECIMAL(19,4) NOT NULL,
...
-- CreateIndex
CREATE INDEX "inventory_transactions_orgId_itemId_sequence_idx" ON "inventory_transactions"("orgId", "itemId", "sequence" DESC);

-- CreateIndex
CREATE INDEX "inventory_transactions_orgId_date_idx" ON "inventory_transactions"("orgId", "date");

-- CreateIndex
CREATE INDEX "inventory_transactions_orgId_sourceType_sourceId_idx" ON "inventory_transactions"("orgId", "sourceType", "sourceId");

-- CreateIndex
CREATE UNIQUE INDEX "inventory_transactions_itemId_sequence_key" ON "inventory_transactions"("itemId", "sequence");

-- CreateIndex
CREATE INDEX "inventory_adjustments_orgId_date_idx" ON "inventory_adjustments"("orgId", "date" DESC);

-- CreateIndex
CREATE UNIQUE INDEX "inventory_adjustments_orgId_number_key" ON "inventory_adjustments"("orgId", "number");

-- CreateIndex
CREATE UNIQUE INDEX "inventory_adjustments_id_orgId_key" ON "inventory_adjustments"("id", "orgId");

-- CreateIndex
CREATE INDEX "inventory_adjustment_lines_orgId_itemId_idx" ON "inventory_adjustment_lines"("orgId", "itemId");

-- CreateIndex
CREATE UNIQUE INDEX "inventory_adjustment_lines_adjustmentId_lineNumber_key" ON "inventory_adjustment_lines"("adjustmentId", "lineNumber");
...
-- AddForeignKey
ALTER TABLE "inventory_transactions" ADD CONSTRAINT "inventory_transactions_journalId_fkey" FOREIGN KEY ("journalId") REFERENCES "journals"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "inventory_adjustments" ADD CONSTRAINT "inventory_adjustments_orgId_fkey" FOREIGN KEY ("orgId") REFERENCES "organizations"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "inventory_adjustments" ADD CONSTRAINT "inventory_adjustments_accountId_fkey" FOREIGN KEY ("accountId") REFERENCES "ledger_accounts"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "inventory_adjustments" ADD CONSTRAINT "inventory_adjustments_journalId_fkey" FOREIGN KEY ("journalId") REFERENCES "journals"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- CreateEnum
CREATE TYPE "PurchaseDocumentType" AS ENUM ('BILL', 'EXPENSE', 'VENDOR_CREDIT', 'PURCHASE_ORDER');

-- CreateEnum
CREATE TYPE "PurchaseDocumentStatus" AS ENUM ('DRAFT', 'OPEN', 'PARTIAL', 'PAID', 'VOID', 'CLOSED');
...
CREATE TABLE "bill_payments" (
    ...
    "exchangeRate" DECIMAL(19,9) NOT NULL DEFAULT 1,
    "journalId" TEXT,
    "status" "PurchaseDocumentStatus" NOT NULL DEFAULT 'OPEN',
    "voidedAt" TIMESTAMPTZ(6),
    "voidReason" TEXT,
    "createdById" TEXT,
    "createdAt" TIMESTAMPTZ(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreateIndex
CREATE UNIQUE INDEX "purchase_documents_convertedFromId_key" ON "purchase_documents"("convertedFromId");

-- CreateIndex
CREATE INDEX "purchase_documents_orgId_type_status_date_idx" ON "purchase_documents"("orgId", "type", "status", "date" DESC);

-- CreateIndex
CREATE INDEX "purchase_documents_orgId_vendorId_date_idx" ON "purchase_documents"("orgId", "vendorId", "date" DESC);

-- CreateIndex
CREATE INDEX "purchase_documents_orgId_dueDate_idx" ON "purchase_documents"("orgId", "dueDate");

-- CreateIndex
CREATE UNIQUE INDEX "purchase_documents_orgId_type_number_key" ON "purchase_documents"("orgId", "type", "number");

-- CreateIndex
CREATE UNIQUE INDEX "purchase_documents_id_orgId_key" ON "purchase_documents"("id", "orgId");

-- CreateIndex
CREATE INDEX "purchase_document_lines_orgId_itemId_idx" ON "purchase_document_lines"("orgId", "itemId");

-- CreateIndex
CREATE UNIQUE INDEX "purchase_document_lines_documentId_lineNumber_key" ON "purchase_document_lines"("documentId", "lineNumber");

-- CreateIndex
CREATE INDEX "bill_payments_orgId_vendorId_date_idx" ON "bill_payments"("orgId", "vendorId", "date" DESC);

-- CreateIndex
CREATE INDEX "bill_payments_orgId_status_idx" ON "bill_payments"("orgId", "status");

-- CreateIndex
CREATE UNIQUE INDEX "bill_payments_orgId_number_key" ON "bill_payments"("orgId", "number");

-- CreateIndex
CREATE UNIQUE INDEX "bill_payments_id_orgId_key" ON "bill_payments"("id", "orgId");

-- CreateIndex
CREATE INDEX "purchase_applications_orgId_billId_idx" ON "purchase_applications"("orgId", "billId");

-- CreateIndex
CREATE UNIQUE INDEX "purchase_applications_paymentId_billId_key" ON "purchase_applications"("paymentId", "billId");

-- CreateIndex
CREATE UNIQUE INDEX "purchase_applications_creditDocumentId_billId_key" ON "purchase_applications"("creditDocumentId", "billId");

-- AddForeignKey
ALTER TABLE "purchase_documents" ADD CONSTRAINT "purchase_documents_orgId_fkey" FOREIGN KEY ("orgId") REFERENCES "organizations"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "purchase_documents" ADD CONSTRAINT "purchase_documents_vendorId_fkey" FOREIGN KEY ("vendorId") REFERENCES "vendors"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "purchase_documents" ADD CONSTRAINT "purchase_documents_paymentTermId_fkey" FOREIGN KEY ("paymentTermId") REFERENCES "payment_terms"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "purchase_documents" ADD CONSTRAINT "purchase_documents_paymentAccountId_fkey" FOREIGN KEY ("paymentAccountId") REFERENCES "ledger_accounts"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "purchase_documents" ADD CONSTRAINT "purchase_documents_journalId_fkey" FOREIGN KEY ("journalId") REFERENCES "journals"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "purchase_documents" ADD CONSTRAINT "purchase_documents_convertedFromId_fkey" FOREIGN KEY ("convertedFromId") REFERENCES "purchase_documents"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "purchase_document_lines" ADD CONSTRAINT "purchase_document_lines_documentId_fkey" FOREIGN KEY ("documentId") REFERENCES "purchase_documents"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "purchase_document_lines" ADD CONSTRAINT "purchase_document_lines_itemId_fkey" FOREIGN KEY ("itemId") REFERENCES "items"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "purchase_document_lines" ADD CONSTRAINT "purchase_document_lines_taxCodeId_fkey" FOREIGN KEY ("taxCodeId") REFERENCES "tax_codes"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "purchase_document_lines" ADD CONSTRAINT "purchase_document_lines_expenseAccountId_fkey" FOREIGN KEY ("expenseAccountId") REFERENCES "ledger_accounts"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "bill_payments" ADD CONSTRAINT "bill_payments_orgId_fkey" FOREIGN KEY ("orgId") REFERENCES "organizations"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "bill_payments" ADD CONSTRAINT "bill_payments_vendorId_fkey" FOREIGN KEY ("vendorId") REFERENCES "vendors"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "bill_payments" ADD CONSTRAINT "bill_payments_paymentAccountId_fkey" FOREIGN KEY ("paymentAccountId") REFERENCES "ledger_accounts"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "bill_payments" ADD CONSTRAINT "bill_payments_journalId_fkey" FOREIGN KEY ("journalId") REFERENCES "journals"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "purchase_applications" ADD CONSTRAINT "purchase_applications_paymentId_fkey" FOREIGN KEY ("paymentId") REFERENCES "bill_payments"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "purchase_applications" ADD CONSTRAINT "purchase_applications_creditDocumentId_fkey" FOREIGN KEY ("creditDocumentId") REFERENCES "purchase_documents"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "purchase_applications" ADD CONSTRAINT "purchase_applications_billId_fkey" FOREIGN KEY ("billId") REFERENCES "purchase_documents"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
